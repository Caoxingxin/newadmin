<template>
    <div class="container">
        ...
        <el-dialog title="添加课程" :visible.sync="dialogFormVisible" width="800px" top="20px" :close-on-click-modal="false"
            ...
            <el-form ref="form" :rules="rules" :model="create_form" :label-position="labelPosition" label-width="100px">
                <el-form-item label="课程名称:" prop="name">
                    <el-input v-model="create_form.name" autocomplete="off"
                              style="width: 200px !important;" placeholder="请输入课程名称" size="small">
                    </el-input>
                </el-form-item>
                <el-form-item label="课程类型:" prop="type">
                    <el-input v-model="create_form.type" autocomplete="off"
                              style="width: 200px !important;" placeholder="请输入课程类型" size="small">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="时长(分):" prop="duration">
                    <el-input v-model="create_form.duration" autocomplete="off"
                              style="width: 200px !important;" placeholder="请输入时长" size="small">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="描述:" prop="description">
                    <el-input type="textarea" v-model="create_form.remark" autocomplete="off"
