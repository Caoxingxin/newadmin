        ...
        <el-card class="box-card">
            <el-row :gutter="20">
                ...
                <el-col :span="6" style="margin: 10px 10px 0 0">
                    <el-input placeholder="请输入电话" size="small" v-model="searchStudentMobile" clearable @clear="list(1)">
        ...
        <el-dialog title="学生信息" :visible.sync="dialogFormVisible" width="800px" top="20px" :close-on-click-modal="false"
            ...
            <el-form ref="form" :rules="rules" :model="create_form" :label-position="labelPosition" label-width="100px">
                ...
                <el-form-item label="工作单位:" prop="company">
                    <el-input v-model="create_form.company" autocomplete="off"
                              style="width: 500px !important;" placeholder="请输入工作单位" size="small">
                    </el-input>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        if (this.updateStatus) {
                            let url = 'head/headStudent-update'
                            this.axios.post(url, {
            ...
            //学生信息详情
            Deatil(id) {
                let url = 'head/headStudent-detail'
                this.axios.post(url, {
                    id: id,
                }).then(response => {
            ...
            page(value) {
                let url = 'head/headStudent-list?page=' + value
                this.axios.get(url).then(response => {
                    this.currentPage = response.data.current_page
                    this.tableData = response.data.data;
                    console.log(this.tableData);
