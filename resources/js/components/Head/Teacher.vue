<template>
    <div class="container">
        <el-card class="box-card">
            ...
            <el-table :data="tableData" style="width: 100%" border stripe v-loading="loading">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.status === 10" type="success" size="mini"
                                   @click="statusDialog(scope.row)">转正
                        </el-button>
        ...
        <el-dialog title="添加教师" :visible.sync="dialogFormVisible" width="800px" top="20px" :close-on-click-modal="false"
            ...
            <el-form ref="form" :rules="rules" :model="create_form" :label-position="labelPosition" label-width="100px">
                ...
                <el-form-item label="入职日期:" prop="entry_time">
                    <el-date-picker
                        v-model="create_form.entry_time"
                        type="date"
                        placeholder="选择日期"
                ...
                <el-form-item label="住址:" prop="address">
                    <el-input type="textarea" v-model="create_form.address" autocomplete="off"
                              :autosize="{ minRows: 4, maxRows: 6}" placeholder="住址" size="small">
                    </el-input>
                </el-form-item>
