  ...
  methods: {
    ...
    Deatil: function Deatil(id) {
      ...
      this.axios.post(url, {
        ...
        _this6.create_form.train_time = [_this6.create_form.start_date, _this6.create_form.end_date];
        _this6.create_form.register_time = [_this6.create_form.register_start_at, _this6.create_form.register_end_at];
        _this6.imageUrl = _this6.create_form.picture;
        _this6.updateStatus = true;
        console.log(_this6.create_form.examine);
      })["catch"](function (error) {
        alert('错误');
      });
    },
    ...
    page: function page(value) {
      ...
      var url = 'school/schoolSemester-list?page=' + value;
      this.axios.get(url).then(function (response) {
    ...
    Delete: function Delete(row) {
      ...
      this.axios.post(url, {
        ...
        _this8.list(_this8.currentPage, null, _this8.schoolValue);
